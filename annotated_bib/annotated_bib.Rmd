...
**Env Res Lett - review in green infrastructure ecosystem services**
...
**Cameron and Blanuša. 2016. Ann Botany - green infrastructure and plant traits**
...
**Mitsch. 2003. Ecol Eng - What is ecological engineering??** 
...
**Payne et al. 2018. Adv Water Res - Guideline to plant selection for biofilters** 
...
**Le Cousumer et al. 2012. Water Research - Plant traits and stormwater biofilters** 
...
**Carter and Fowler. 2008. Env Manag - A review of green roof policies** 
...
**Felson et al. 2013. BioSci - including ecologists in urban infrastructure projects** 
...
**Lundholm et al. 2015. Env Sci Tech - green roofs and aboveground traits**
...
**Lundholm. 2015. J Appl Ecol - role of species diversity in green roof services**
...
**Lundholm et al. 2010. PLOS one - role of plant functional groups in green roof services**
...
**Lundholm. 2015. Front Evo Evo - green roofs as constructed ecosystems**
...
**Farell et al. 2013. Plant Soil - physiological traits and drought survival in green roofs**
...
**Szota et al. 2017. Sci Total Env - physiological traits in green roofs**
...
**Mentens et al. 2006. Landsc Urban Plan - green roofs and stormwater runoff**
...
**Getter et al. 2006. HortSci - green roofs and ecosystem services** 
...
**Oberndorfer et al. 2008. Biosci - hreen roofs as urban ecosystems**
...
**Doug et al. 2005. Ryerson University - Toronto Report on Green Roof Benefits** 
...
**McGuire et al. 2013. PLOS. Green roof and microbial communities**
...
**Starry et al. 2017. Parameterizing green roof stormwater balance models** 
...
**Du et al. 2018. Green roof plant traits + drought survival** 
 - green roof vegetation can improve storwater through transpiration
 - high transpiration dries out soil faster, more rain in soil after flood 
 - but, plants with high transpiration may not be the best at drought survival
 - common species: sedum spp, great at survival but not the best at transpiration
 - plant selection using: plant traits, different plant groups, habitat template 
 - none have looked at climate of origin approach 
 - shrubs are useful on green roofs: high water use, and high survival
 - drought-survival: deep roots (water spenders) or stomatal close (water savers)
 - selected shrub plants based on heat moisture index
 - cool note: species were harvested on diff days based on "dry-down" rates
 - measured mid-day water potential, SLA, LAR, RGR, and biomass
 - large variation in trait responses across 20 spp - evolutionary origins
 - high water-users were not very good at drought survival
 - woody plants: large xylem vessels 
  - good for water use, 
  - but low cavitation resistance under low water potentials 
 - leaf area adjustment was not the major driver of water use
  - changes in leaf area % dd not lead to changes in ET  

# Background - green roofs + roots

## [@Lu2014] 

**Lu et al. 2014. Urban Forest Green - root morphology changes in green roofs"**
- similar study to Lu et al. 2015. Ecol Eng 
- looked at different watering regimes on root morphology of Sedum lineare
- water treatments were irrigating every 2, 6 and 13 days
- found that consistent watering had a positive effect on root growth + biomass
- but, reduced irrigation produced thinner roots, which may help water uptake ability
  - roots growing at lower water potential tended to be thinner
  - root:shoot ratio increases during drought to explore more soil 
  - larger roots may require more resources, result in poorer performance
  - thinner roots with less lateral roots may favor water uptake after drought conditions

## [@Lu2015] 

**Lu et al. 2015. Ecol Eng - drought + substrate effect on sedum roots in green roofs**
- green roof substrate
  - deep substrate has higher water holding capacity + more stable soil temperature  
  - but, substrate also contains roots: lack of info on root morphology wrt to drought survival
  - root dehydrogenase activity used to determine drought survival; related to root mortality
- only tested on a single Sedum species (Sedum lineare)
  - apparently, verry popular in Shanghai China for green roofs 
  - used three different substrate depths (4, 7, 10 cm) and two water irrigation treatments
  - measured root dry mass, root fresh mass, shoot, total root length, root volume
- found that shallow substrates (4 cm) had higher overall root growth 
  - could be that deep substrates don't really benefit succulent species (shallow roots)
  - drainage layer in green roof modules can aid in more water uptake through roots
- but, 10 cm substrate allows for greater chance of prolonged drought survival
  - better maintenance of plant water status and root activity under severe drought
  - more subtrate can hold more water 
  - smaller plants also use less water than big ones; so it can tolerate shallow depths

## [@Ji2018]
** Ji et al. 2018. Plant Soil - root foraging of sedum species in green roofs **
- stressful environment limit root foraging in many plants
- desert succulent species
  - typically have shallow roots with wide lateral spread
  - rely on periodic rainfall to obtain resources
  - low loss of water during dry periods
- green roof succulent species
  - less extreme environments
  - some spp have flexible photosynthetic strategies (e.g. CAM)
- 
...
**Keddy. 1992. Func Eco - a practical approach to doing functional ecology** 
...
**Ma et al. 2018. Nature - global evolution and root traits**
...
**Li et al. 2015. Ecol Lett - decoupling leaf and hydraulic traits**
...
**Zobel and Zobel. 2002. J Ecol - Is root biomass important for competition?**
...
**Belluau and Shipley. 2018. PLOS ONE - soft traits vs. hard traits. Which is better?**
...
**Schenk and Jackson. 2002. J Ecol** 
...
**Gould et al. 2016. Ecol Lett - soil physical properties and biodiversity** 
...
**Erktan et al. 2018. Plant Soil - research advances in root traits and ecosystem functioning**
...
**Carminiata et al. 2017. New Phytologist - root hairs affect soil water uptake** 
...
**Smilaurea and Simauler. 2002. New Phyt - root morphology and soil heterogeneity**
...
**Dhiram et al. 2017. Plant Soil - soil water uptake using neutron radiography** 
...
**Reich. 2014. J Ecol - fast-slow economic spectrum**
...
**Kramer-Walter, K. R. et al. 2016. J Ecol** 
...
**Mommer and Weemstra. 2012. New Phyt**
...
**Bergmann et al. 2017. New Phytologist**
...
** Poorter and Bergkotte. 1992. Plant Cell Environment - chem composition of 24 spp**
...
** Taub et al. 1996. Func Eco - comparative root ecology **
...
**Ryser. 2006. Plant Soil - the mysterious root lengths (and some drawbacks)** 
...
**Johnson and Lehmann, 2006 - root preferential flow**
...
**Silverton et al. 2015. J Ecol - hydrological niches in terrestrial plant communities**
...
**Violle et al. 2007. Oikos - definition of functional traits** 
...
**Fort et al. 2017. Func Eco - water uptake in mediterranean ecosystems** 
...
## [@Valverde-Barrantes2015] 

**Valverde-Barrantes et al. 2015. Func Eco - phylogenetics and root structure** 
...
**Larson et al. 2016. New Phyt - root traits under different water availabilities** 
...
**Perez-Ramos et al. 2012. J Ecol - whole-plant spectrum under an environmental gradient**
...
**Freschet et al. 2017. J Ecol - climate and root traits** 
...
**Huang et al. 1993. New Phytologist - hydraulic conductivity + soil water in cacti**
...
**Ahmed et al. 2014. Plant Func Biol - Mucilage to increase water uptake**
...
**Iversen et al. 2015. New Phytologist - habitat template for green roofs: arctic tundra**
...
**Comas and Eissentat. 2004. Func Eco - link fine roots to maximum growth potential** 
...
**Reynolds et al. 2017. Tree Physio - geneXtraitXenvironment for hydraulic niches** 
...
**Hernandez et al. 2010. Plant Ecol** 
...
**Freschet and Roumet. 2017. Func Eco - functional consensus of root traits** 
...
**Roscher et al. 2018. Ecology - trai origins affect biodiversity in grasslands**
...
**Comas et al. 2012. Int J Plant Sci**
...
**Freschet et al. 2010. J Ecol - leaf-stem-root coordination in subarctic ecosystem**
...
**Roumet et al. 2016. New Phyt - RES and the carbon economy**
...
**Zhou et al. 2018. J Ecol - TES and phylogenetic structure**  
...
**Eshel & Beeckman. 2001. Roots: the Hidden Half - textbook on general root stuff** 
- roots are a biological system comprised of different components
  - coarse roots: tap roots, functions as an ‘anchor’ 
  - fine roots: 
    - lateral branches, active for water use, most of surface area
    - tend to increase hydraulic conductivity + increase transport efficiency
    - higher turnover rate than coarse roots, higher nutrient concentrations
  - higher-order roots: thicker roots, transport and storage functions
  - lower-order roots: N-rich tissues, mycorrhizal colonization and perform soil resource uptake
  - branching structure of root systems: geometry can be represented as tree (# of links, length of links)
  - distribution of branches within the system: branching angles (radial angle, branch angle)
  - relative diameter – rate of increase of link diameter with magnitude
- functional implications of root architecture 
  - cost: carbon - currency to determine cost-benefit analysis of root architecture
  - construction
    - carbon used for structure: ash-free dry weight of the root system
    - carbon used for respiration: linearly related to growth rate
- SRL: closely related to tissue density
  - construction cost is proportional to biomass
  - a function of tissue volume 
  - root diameter contributes as its square
- transport
  - transport-relate costs
  - driving force for transport, which increase with distance
  - xylem: cost arises from need to maintain water potential gradient
  - phloem: costs arises from transport distance
- major determinants of transport efficiency
  - lengths of the interior and exterior links
- resistance they offered to transport
  - if resistance == link lengths, transport efficiency is function of path length
  - still, root resistance is important
  - diameter of links declines with path length + resistance increases
- soil exploration and exploitation
  - complicated subject: large variation in soil (space + time)
  - resource vary in mobility
- roots are generally more abundant in surface soils than deeper horizons
  - CAM succulents – superficial root systems
  - deciduous plant species – deeply penetrating tap roots
- dichotomous systems vs herringbone systems
  - dichotomous: easy to construct and maintain, good at transporting immobile resources
  - herringbone: expensive to build, good at transporting mobile resources
- anchorage 
  - two situations for plant anchorage
  - simple upward force – e.g. grazing
  - horizontal force is exerted on the stem – e.g. wind
  - what affects plant anchorage? root quality, distribution, branching pattern
  - finely branched regions play little role in anchorage
  - proximal parts of roots are responsible anchorage strength
  - important: safely ignore anchorage when interpreting resource acquisition
- plasticity of root Systems 
  - large heterogeneity in belowground traits
  - different components of root systems should exhibit phenotypic plasticity 
  - opportunists should show high phenotypic plasticity as they try to exploit available resource pulses 
  - large range of possible root structures
- root-shoot relations 
  - species will show marked differences in biomass distribution in a fashion related to differences in their 
    - habitat affinities
      - functional balance in shoots and root systems should exists 
      - depends on resource supply + species identity
    - shade-tolerants display shoot biomass allocation to develop bigger leaves
    - plants in limited soil resources should allocate more resources to roots
  - biomass distribution is a function of both biomass allocation and turnover
    - root mass fraction
      - similar definition to root:shoot ratio
      - preferred because of statistical reasons
  - water
    - invest in excessive amount of roots prior to water shortage
    - may be adapted to periodic and unpredictable drought
  - plants should plastically shift biomass allocation to have a higher resource gain
    - under a new situation than would otherwise occur without such a shift
    - other traits influence carbon gain other than biomass allocation
    - traits that enhance resource gain might not necessarily enhance survival
  - variation in root-shoot relationship among species
    - for forests, plants growing under lower nutrient and water availability:
      - tend to have a greater RMF
      - greater shift toward fine-root than toward foliage production
  - root life span, efficiency, and turnover 
    - roots have a life history: from birth to death
    - stronger root competition than shoot competition
    - root demography also influences ecosystem processes – i.e. BNPP
  - variation in root life-span 
    - median life span of the finest roots can range from <20 days in fast growing tree
    - to >1 year in slow-growing forest trees
    - variation likely caused by environmental conditions and species identity
  - patterns of variation among species 
    - plant species of low growth rates tend to have long root lifespan
    - influence of root diameter and root order 
    - root order describes the position of a root in the branching pattern
    - variation in root life-spans is associated with the size and order of the roots
- value of cost-benefit models applied to roots
  - benefit: nutrient and water uptake
  - cost: material and energy required to build and maintain roots
  - if plants were to deploy roots to maximize ROI
    - benefit: cost ratio should be maximized
    - cost: carbon content + respiration
      - high initial C investment to build roots
      - cost of respiration fluctuates
      - respiration declines with age based on metabolic activity
      - always be costlier to rebuild roots than to keep old ones
      - unless there is declining uptake capacity of older roots
- abiotic factors influencing root life-span
  - soil moisture
  - reduces C allocation to roots, root respiration + nutrient uptake
  - increases root mortality
  - adaptation: species with fine lateral roots --> high hydraulic conductivity --> shed roots in dry soils, regrow in wet soil
  - soil temperature: high temperatures --> shorter root life-span
  - soil nutrients: conflicting results on the effects of soil nutrients on root life-span
- biotic factors influencing root life-span
  - available photosynthates
  - factors that reduce shoot C acquisition reduces root longevity
  - mycorrhizal Fungi
  - If mycorrhizal roots acquire more nutrients for less carbon
  - then the plant may actively maintain + defend mycorrhizal fungi

## [@Rabbi2018] 

**Rabbi et al. 2018. New Phytologist**
...
**Bardgett. 2014. Biology and Env - root traits and ecosystem functioning** 
...
- to fix one molecule of CO2 the plant will typically transpire 200–400 molecules of water
= depending on humidity and on stomatal conductance (Raven, 1984)
- that plants are generally more productive when grown in high humidity 
  - indicates that the cost of transpiration outweighs any direct benefits 
  - in terms of leaf cooling or nutrient transport (Salisbury and Ross, 1992)
- to obtain an adequate supply of water…
  - plants invest a considerable portion of their resources 
-  in building/maintaining uptake and transport tissues that fix practically no CO2
- the size of this investment depends on plant and habitat:
  - in cool desert shrubs, root biomass can be 3X shoot biomass
  - in submerged aquatic plants, root biomass may be as little as 6% of the shoot
  - successful competitor will achieve maximum water supply for a given investment
- two axioms
  - plant water use cannot exceed the supply capacity of the soil-to-leaf pipeline
  - selection cause plants to max water supply per investment in transport tissue
- mechanisms of water uptake
  - transpiration pull –
    - water evaporation from the surfaces of mesophyll cells to the atmosphere
    - creates a negative pressure at the top of a plant
    - resulting surface tension causes a negative pressure in xylem 
    - that pulls the water from the roots and soil
    - requires that vessels transporting the water are very small in diameter
    - otherwise cavitation would break the water column
- root pressure -
  - if ψR < ψS,  usually due to high concentrations of solute
  - water can move by osmosis into the root from the soil
  - creates positive pressure that forces sap up the xylem towards the leaves
  - root pressure is highest in the morning before the stomata open 
  - and allow transpiration to begin
- cohesion-tension theory
  - darcy’s Law: E = -K(ψ)*(dψ/dx) (Eshel & Beeckman, 2013)
  - E: transpiration rate per leaf area, can be predicted from:
    - root-to-leaf area ratio (AR/AL)
    - root depth profile
    - soil water profile (ψm)
  - K: hydraulic conductivity per leaf area, depends on (3):
    - (1) soil texture
    - (2) tissue properties
    - (3) cavitation sensitivity
  - K declines with increasing negative ψ
  - Ecrit – max hydraulically possible transpiration rate
    - provides info on:
    - max water extraction capability (area under WU envelope)
    - permanent wilting point (ψm below which water uptake ceases)
  - pressure gradients move water through xylem results from:
    - positive pressures at the base of the plant;
    - negative pressure at the top of the plant
 - water at the top develops negative hydrostatic pressure
  - pulls through H2O @ xylem due to tension @ leaf cell wall
  - water is lost to the air
  - forms curved air-water interfaces in cell walls
- more water is lost; increases negative pressure
- cohesion-tension theory of sap ascent
  - how water can move through plants w/o expending metabolic energy
  - xylem transport of water in trees face physical challenges
    - (1) water under tension transmit an inward force to xylem walls
    - (2) water under tension is in a physically metastable state
  - high activation energy for liquid-vapor phase
  - xylem structure minimizes presence of nucleating sites
  - water movement from the leaf to the atmosphere From leaf to atmosphere
    - (1) water pulled from xylem to mesophyll
    - (2) water vapor exits leaf through stomatal pore (diffusion)
  - transpiration from leaf depends on
    - (1) cwv(leaf) – cwv(air)
    - (2) diffusional resistance ®
    - (3) leaf stomatal resistance (rs)
    - (4) leaf boundary layer resistance (rb)
  - stomatal control couples leaf transpiration to leaf photosynthesis
    - if plants prevent water loss, then they exclude CO2
    - [CO2] gradient is much smaller than [H2Ov] gradient
      - very little CO2 in air
      - relatively high [water vapor] within leaf
      - when soil water is abundant, then stomatal pores will close
  - transpiration ratio
    - measures relationship between water loss and carbon gain
    - defines as amount of water transpired by plant/amount of CO2 assimilated by photosynthesis
    - the inverse is usually defined for water-use efficiency
- plant-soil-atmosphere continuum
  - movement of water through plants from areas of high to low ψ
  - Ψsystem = Ψtotal = Ψs + Ψp + Ψg + Ψm
  - Ψsoil > Ψroot > Ψstem > Ψleaf > Ψatmosphere
  - low water potential of atmosphere + higher water potential inside leaves
  - leads to a diffusion gradient across the stomatal pores of leaves
  - drawing water out of the leaves as vapour
  - as water vapour transpires out of the leaf
    - further water molecules evaporate off the surface of mesophyll cells
    - replace the lost molecules since water in the air inside leaves
    - maintained at saturation vapour pressure
  - water lost at the surface of cells is replaced by water from the xylem
    - due to cohesion-tension properties of water 
  - plants pulls water molecules through xylem from the roots toward leaf
- growth-induced water uptake
  - growing cells initiate water movement by a plastic yielding of their walls
  - causes a drop in cell turgor +  Ψw
  - draws water out of the apoplast + creates same capillary pressure as transpiration pull 
  - (but from water movement to cells rather than atmosphere)
- osmotic uptake
  - accumulation of ions in apoplast of stele creates a Ψo gradient 
  - across endodermis
  - drawing water into the root stele
  - creates a positive pressure that pushes water up xylem 
  - … and drip from foliar hydathodes.

** Role of roots in soil water uptake**
- root systems have these useful traits for role as collectors and conductors of water
  - root length – soil exploration
  - root surface area - contact with soil water pores, hydraulic conductivity
- root xylem is much more efficient than stem xylem
  - conductivities per unit xylem are over 4X those of shoots
  - enables relatively thin roots and minimal taper with length
  - minimizes cost of production and maintenance
- multiple pathways as water travels across primary root to xylem
  - symplastic: water flow from epidermis to root xylem through living cells
  - apoplastic – water moves through cell walls

** Limitations on transpirational water supply **
- darcy’s law as a “supply function”
- Fick’s law as a “demand function”: E = gL∆w
  - E = leaf area-specific transpiration rate
  - GL = leaf-specific stomatal conductance
  - ∆w = leaf-air mole fraction differences
- properties of K and Ψw limit the action of stomata
  - K is a direct function of Ψz
- a point of diminishing return is reached due to a declining K
- beyond maximum point, K will drive to zero – “weak link’ in continuum
- Darcy’s law has limitations that constrain stomatal regulation of water use
- conclusion: demand cannot exceed supply

** Behaviour of hydraulic conductivity **
- limitation of water uptake depends:
  - on how it influences the total bulk soil-leaf-conductance (t1)
  - t1: represents integral of K wrt distance along the soil-to-leaf flow path
  - expressed as the volume flow rate per ∆Ψ from bulk soil to foliage
- soil hydraulic conductivity 
  - soil K – volume flow rate per (dψ/dx) per cross-sectional area of soil
  - as water is pulled from soil due to transpiration, Ψm drops
  - capillary forces fail and water in the soil pores is replaced by air
  - as the pores empty, fewer are available to conduct water, and K drops.
- response of K to declining Ψm is immediate
  - depends on distribution of pore sizes
  - sandy soil: uniform large pore channels --> higher K when saturated; plummets rapidly with Ψm
  - fine soils: wider range of pore sizes --> lower saturated K --> maintain K over wide negative
  range of Ψm
- soil-root pathway can be divided into two components
  - rhizosphere conductance
    - flow path across cylindrical sheath of soil over 3mm thickness around root
    - high E causes steepen Ψ gradients and lower conductance
    - low AR/AL steepen Ψ gradients
    - transpiration H2O is forced to cross a smaller surface area as it moves into roots
 - pararhizal conductance
  - flow path towards the rooting zone in the bulk soil
- xylem hydraulic conductivity 
  - xylem K - volume flow rate per ψp/dx per leaf area 
  - as ψp drops, xylem conduits cavitate
  - emptying their water and becoming embolized and nonconductive
- root pressure can reverse xylem cavitation 
  - as long as transpiration is low and soil ψw is not too negative
  - in absence of cavitation, the total resistance to flow in xylem 
  - can account for 10-40% of total soil-to-leaf resistance
  - root depth/aboveground size are important in xylem resistance

**Radial flow path through root tissue**
- radial conductance
  - the narrower the root cortex, the higher tends to be the radial conductance
  - often measured on the relatively short excised root tips 
  - where the axial xylem conductance can be factored out
- conductance increases from early morning to midday before falling off again later
- transpiration in the morning shifts the driving force for uptake from osmosis to pressure
- drop in root conductance may be due to water draining from extracellular spaces in root cortex 
  - as ψw  becomes more negative – reduces area for apoplastic water flow
- root uptake capability can also be affected by solute concentration
  - as solute levels increase in the rhizosphere and cortical apoplast
  - solute drag and reduction of the driving force would be prominent 
  - (especially in saline or hyper fertilized soils)

** Predicting the weak-link in the continuum **
- AR/AL  
- low AR/AL: 
  - hydraulic failure occurs in the rhizosphere owing to a extremely steep Ψm 
  - cuts off access to bulk soil water; reduces water extraction potential
- high AR/AL: water extraction potential increases to a plateau; 
  - hydraulic failure shifts from roots to xylem; no longer an advantage to increasing AR/AL
  - threshold for AR/AL required to max water extraction from a drying soil; 
  - highly dependent on soil type
- coarser soils: h
  - higher AR/AL threshold; soil type has a sensitive K(Ψ) function 
  - higher root surface area is required to keep Ψm gradient in the rhizosphere 
  - from triggering critically low soil-root conductance
- xlem is predicted to be the weak link in the continuum 
  - whether the failure occurs in the root or shoot xylem depends on the K(Ψp) function 
  - (but much more sensitive in roots)
- in this case, the point of failure in the xylem appears to depend on Ψm of bulk soil
  - when Ψm is less negative under wet conditions, failure may occur in the shoot system
  - when Ψm becomes more negative under drought, failure can shits to the root xylem
- roots may be acting as a hydraulic fuse
  - smaller roots are more vulnerable to cavitation
  - smaller roots may die when exposed to drought, 
  - but smaller roots but can be regrown when soil re-wets (small carbon cost)
- these peripheral parts are more easily replaced
- failure occurs in coordination in fine roots and minor branches

# Background - soil science

## [@Tarboton1982]

** Rainfall run-off processes - Ch4 soil properties **
- water can move through soil because it is a porous medium
- matrix of solid granular particles + voids filled with water/air
- some key properties of soil 
  - air porosity - number of voids per volume unit 
  - volumetric soil moisture content - volume of water per total volume
  - soil particle density - weighted average density of mineral grains in soil
  - soil bulk density - dry density of soil 
- flow of water through soil is determined by size and shape of pores
- can plot a cumulative frequency plot of grain diameter versus weight fraction
- steeper slopes == uniform soil grain size distribution
- particle size distribution is governed by soil texture 
  - a mixture of clay, silt and sand
  - clay soil - diameter of less than 0.002 mm
  - silt soil - diameter range of 0.002 to 0.05 mm
  - sandy soil - diameter range of 0.05 to 2 mm
- macroscopic scale: flow through porous medium in one direction - Darcy’s law
  - flow of rate Q is proportional to hydraulic conductivity K
  - hydraulic conductivity - size and tortuosity of pores, viscosity, density 
  - but, flow rate can be multidimensional … makes things a bit more complicated
- small pores hold more water than large pores
  -  higher surface tension induced in smaller pores around pore perimeter
- at some point, downward drainage has to “materially cease”
  - at this point, the amount of water remaining in soil - field capacity
  - no inherent definition of what “materially cease” really means
  - for sandy and loamy, three days after saturation is a decent rule of thumb
  - can define field capacity as moisture content corresponding to a pressure head
- in natural ecosystems, water can be removed from saturated soil by:
  - direct evapotranspiration
  - plant uptake
  - note: plants cannot exert suctions stronger than ~15000cm

# Methodology: root sampling 

## [@Perez-Harguindeguy2013] 

**Pérez-Harguindeguy et al. 2013. Austr J Botany**
- root mass fraction
...
**Pierret et al. 2013. Plant Soil - using IJ_RHIZO**
...
**Bouma et al. 2000. Plant Soil - recs for scanning root traits** 
...
**Birouste et al. 2014. Plant Soil** 
...
**Delory et al. 2017. Methods Eco Evol - comparing image analysis softwares**
...
**Himmelbauer et al. 2004. Plant and Soil - ROOTEDGE software for root traits**
...
**Rose. 2017. Front Plant Sci - re-evaluating methods to measure root diameter**
...
**Kimura. 1998. Plant Soil - root measurement technique to avoid overlapping**
...
**Tennant. 1975. J Ecol - line-intersect method for root sampling** 
...
**McCormack et al. 2015. New Phytologist - redefining fine roots**
...
**Poorter and Sack. 2012. Front Plant Sci**
...
**Eshel & Beeckman. 20013. Roots: the Hidden Half. Textbook with root methods** 
...
**Poorter et al. 2012. Func Plant Bio - the art of growing plants in greenhouses**
...
**Poorter et al. 2012. Func Plant Bio - pot size does matter**
...
**Greenland et al. 2016. Eur J Epidem - huge misuse of p-values and why**
